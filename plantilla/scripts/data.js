...
const reservaIni4 = new Reserva(4,'agustin','local1',6,'F',0)
const reservaIni18 = new Reserva(18,'agustin','local1',6,'P',0)
const reservaIni5 = new Reserva(5,'agustin','local2',6,'F',0)
const reservaIni6 = new Reserva(6,'agustin','local3',6,'F',0)
const reservaIni7 = new Reserva(7,'agustin','local4',6,'F',0)
const reservaIni8 = new Reserva(8,'agustin','local5',6,'F',0)
const reservaIni9 = new Reserva(9,'agustin','local6',6,'F',0)
const reservaIni10 = new Reserva(10,'agustin','local7',6,'F',0)
const reservaIni11 = new Reserva(11,'bruno','local1',6,'F',0)
const reservaIni12 = new Reserva(12,'bruno','local1',6,'C',0)
const reservaIni13 = new Reserva(13,'bruno','local7',6,'C',0)
const reservaIni14 = new Reserva(14,'bruno','local7',6,'C',0)
